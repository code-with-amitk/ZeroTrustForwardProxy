...
- In Forward proxy like solution, Authentication is carried by external IDP and **[JWT](https://code-with-amitk.github.io/Networking/) based tenant identification is not done**.
