...
- In Forward proxy like solution, Authentication is carried by external IDP and **[JWT](https://code-with-amitk.github.io/Networking/OSI-Layers/Layer-7/HTTP/JWT_Token.html) based tenant identification is not done**.
